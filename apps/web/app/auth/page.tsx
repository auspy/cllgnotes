...
import ItemList from "@/components/login/ItemList";
  ...
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row justify-center items-center p-10">
        ...
        {/* Login form */}
        <div className="bg-white flex flex-col items-center p-6 sm:ml-0 md:ml-32 border border-black border-solid rounded-md">
